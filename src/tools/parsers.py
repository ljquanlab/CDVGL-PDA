...
def parse_args():
    ...
    parser.add_argument('--n_epochs', type=int, default=500, help='Number of epochs 100,200,500 3000') #500
    ...
    parser.add_argument("--patience", type=int, default=35,help='255 30 40') # 35
    # new:
    ...
    parser.add_argument('--generalization_benchmarks', type=str, default='protein_split',help=' protein_split,psite_split')
