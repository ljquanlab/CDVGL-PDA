...
def parse_args():
    ...
    parser.add_argument('--n_epochs', type=int, default=500, help='Number of epochs 100,200,500 3000')  
    parser.add_argument('--n_hid', type=int, default=512, help='Hidden layer dimension   1024')# 512
    
    parser.add_argument('--lr', type=float, default=1e-3, help='Learning rate 1e-3')
    parser.add_argument('--w', type=float, default=1e-4, help='weight_decay')
    ...
    parser.add_argument('--baseline_benchmarks', type=str, default='site_disease_1_1',help='none')
    parser.add_argument('--generalization_benchmarks', type=str, default='psite_split',help=' none')
