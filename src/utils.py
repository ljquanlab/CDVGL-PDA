...
class PDA_Predictor:
    def __init__(self, model_path, device=None):
        ...
        self.site_features = np.load('../data/node_feature/psite_blosum_residue_embeddings_71_21.npy')
    ...
    def predict_pair(self, site_id, disease_id):
        ...
        Args:
            site_id: phosphorylation site ID (0-2321)
            disease_id: disease ID (0-293)
        Returns:
